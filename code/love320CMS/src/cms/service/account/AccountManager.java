...
import cms.dao.account.RoleDao;
import cms.dao.account.UserDao;
...
public class AccountManager {
	...
	public void saveUser(User entity) {
		String shaPassword = encoder.encodePassword(entity.getPassword(), null);
		entity.setPassword(shaPassword);
		userDao.save(entity);
	}

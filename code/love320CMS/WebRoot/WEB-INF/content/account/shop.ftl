...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="shop.action" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="shop!input.action" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="shop!delete.action?id={xx_id}" target="ajaxTodo" title="你确定要删除吗？" warn="请选择一个商品"><span>删除</span></a></li>
			<li><a class="edit" href="shop!input.action?id={xx_id}" target="navTab" warn="请选择一个商品"><span>修改</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="shop!deleteIds.action" class="delete"><span>批量删除默认方式</span></a></li>		
			<li class="line">line</li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" postType="string" href="shop!deleteIds.action" class="delete"><span>批量删除逗号分隔</span></a></li>
	...
	<table class="table" width="1000" layoutH="138">
		<thead>
			<tr>
				...
				<th width="120" orderField="id">商品ID</th>
		...
		<tbody>
			...
			<tr target="xx_id" rel="${xx.id}">
				...
				<td>
					<a title="删除" target="ajaxTodo" href="shop!delete.action?id=${xx.id}" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="shop!input.action?id=${xx.id}" class="btnEdit">编辑</a>
					<a title="浏览" target="navTab" href="${base}/html/shop.action?id=${xx.id}" class="btnView" external="true">浏览</a>
				</td>
			</tr>
			</#list>
		</tbody>

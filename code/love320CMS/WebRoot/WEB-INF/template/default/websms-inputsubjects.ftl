...
<#include "navlist.ftl">
<div class="G">
<form method="post" action="websms!savesubjects.action" ">
		  <div class="pageFormContent" >
				<label>发布在校表现     :</label><br/>
				考试成绩科目顺序：<input name="subjectsOrder" size="100" value="语文，数学，英语，物理，化学，政治，历史，总分，排名" type="text" >
				<br/>考试成绩科目类别：<input name="subjectsType" value="" type="text" >如：期中、期末等<br/><br/>

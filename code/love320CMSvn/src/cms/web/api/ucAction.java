...
public class ucAction extends ActionSupport{
    ...
    private void synlogin(String userName){
    	ucCM.synloginApi(userName);
    }
    
    private void synloginout(){
    	ucCM.synloginoutApi();
    }

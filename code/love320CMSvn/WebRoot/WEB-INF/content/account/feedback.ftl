...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="feedback.action" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="feedback!delete.action?id={xx_id}" target="ajaxTodo" title="你确定要删除吗？" warn="请选择一个文档"><span>彻底删除</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="feedback!deleteIds.action" class="delete"><span>批量删除默认方式</span></a></li>		
			<li class="line">line</li>
			<li><a class="edit" href="feedback!input.action?id={xx_id}" target="navTab" warn="请选择一个文档"><span>修改评论</span></a></li>
			<li class="line">line</li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" postType="string" href="feedback!deleteIds.action" class="delete"><span>批量删除逗号分隔</span></a></li>
	...
	<table class="table" width="1000" layoutH="138">
		<thead>
			<tr>
				...
				<th width="120" orderField="id">评论ID</th>
				<th orderField="title">简明标题</th>
				<th orderField="username">评论用户名</th>
				<th width="150" align="center" orderField="dtime">评论时间</th>
			</tr>
		</thead>
		<tbody>
